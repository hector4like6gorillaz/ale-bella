      ...
      <div className={`${style['container-testimonials']}`}>
        <div className={`${style['div-container-info']}`}>
          ...
          <p className={`${style['p-content']}`}>
            These guys are the real deal. C/C/G has been instrumental in helping our ongoing
            marketing and social media needs. The engagement continues to grow and we’re seeing
