...
const OurDescription = () => {
  return (
    <div className={`${style['container-our']}`}>
      ...
      <p className={`${style['p-container-text']}`}>
        Located in Los Angeles, a team comprised of creative disciplines in advertising, design, and
        branding. Our agency size and philosophy allow us to create performance marketing campaigns
        for startups and enterprise companies.
      </p>
